	...
	public function add()
	{
		...
		if (! empty($header))
		{
			if (! empty($details))
			{
				...
				$credit_issue = $header->creditIssue == 1 ? 1 : 0;
				...
				$arr = array(
					...
					'isDefaultShipTo' => $header->isDefaultShipTo,
					...
					'credit_approval' => $is_over_due == 1 ? 'O' : 'P',
					'credit_diff' => $credit_diff,
					'is_over_due' => $is_over_due,
					'isRegular' => $header->isRegular
				);
