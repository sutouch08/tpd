...
<div class="row">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-5 table-responsive">
		<table class="table table-striped table-hover border-1" style="min-width:920px;">
			<thead>
				<tr>
					<th class="fix-width-100 text-center">ID</th>
					<th class="min-width-250">Code</th>
					<th class="fix-width-150">Last sync</th>
					<th class="fix-width-120">Sync by</th>
				</tr>
			</thead>
			<tbody>
			<?php if(!empty($data)) : ?>
...
<script src="<?php echo base_url(); ?>scripts/area_name/area_name.js?v=<?php echo date('Ymd'); ?>"></script>
