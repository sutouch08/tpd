...
<form class="form-horizontal">
    ...
    <label class="col-sm-3 control-label no-padding-right">Customer Team Name</label>
    <div class="col-xs-12 col-sm-4">
			<input type="text" name="name" id="name" class="width-100" maxlength="50" value="<?php echo $data->name; ?>" autofocus required />
    </div>
...
<script src="<?php echo base_url(); ?>scripts/customer_team/customer_team.js"></script>
