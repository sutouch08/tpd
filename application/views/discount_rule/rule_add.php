...
<form class="form-horizontal">
  ...
  <div class="form-group">
    ...
    <div class="col-xs-8 col-sm-1 frist">
			<input type="number" name="min_disc" id="min_disc" class="width-100 text-right" value="" placeholder="0-100" required/>
    </div>
    ...
    <div class="col-xs-8 col-sm-1 frist">
			<input type="number" name="max_disc" id="max_disc" class="width-100 text-right" value="" placeholder="0-100" required/>
    </div>
		<div class="col-xs-4 col-sm-1 padding-5">
			<span>%</span>
    </div>
