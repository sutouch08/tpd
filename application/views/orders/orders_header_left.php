<div class="col-lg-6 col-md-7 col-sm-7 col-xs-12">
  <div class="form-horizontal">
    <div class="form-group">
      <label class="col-lg-3 col-md-3 col-sm-3 col-xs-12 sap-label">V, Q</label>
    ...
    <div class="form-group">
      <label class="col-lg-3 col-md-3 col-sm-3 col-xs-12 sap-label">รหัสลูกค้า</label>
      <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
        <select name="customer" id="customer" class="width-100 e" onchange="getCustomerData()">
    ...
    <div class="form-group">
      <label class="col-lg-3 col-md-3 col-sm-3 col-xs-12 sap-label">ที่อยู่ตามใบกำกับ</label>
    ...
    <div class="form-group">
      <label class="col-lg-3 col-md-3 col-sm-3 col-xs-12 sap-label">สถานที่จัดส่ง</label>
      <div class="col-lg-2 col-md-2 col-sm-2 col-xs-4">
    ...
    <div class="form-group">
      <label class="col-lg-3 col-md-3 col-sm-3 col-xs-12 sap-label">สถานที่จัดส่งเพิ่มเติม</label>
      <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
    ...
    <div class="form-group">
      <label class="col-lg-3 col-md-3 col-sm-3 col-xs-12 sap-label">Vat Group</label>
      <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
        <input type="text" class="form-control input-sm" id="VatGroup" value="" disabled>
        <input type="hidden" id="vatRate" value="">
      </div>
      <label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 sap-label">Currency</label>
